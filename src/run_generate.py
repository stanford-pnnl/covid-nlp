...
def get_command_line_args():
    ...
    parser.add_argument(
        "--demographics_path",
        default="/share/pi/stamang/covid/data/demo/" "demo_all_pts.parquet",
    )
    ...
    parser.add_argument(
        "--drug_exposure_dir", default="/share/pi/stamang/covid/data/drug_exposure"
    )
    parser.add_argument("--concept_dir", default="/share/pi/stamang/covid/data/concept")
    parser.add_argument(
        "--output_dir",
...
def main(args):
    ...
    generate_patient_db(
        ...
        args.meddra_extractions_dir,
        args.drug_exposure_dir,
        args.concept_dir,
        args.output_dir,
        args.debug,
        args.use_dask,
