...
def mental_health_co_morbidities(patients, search_terms):
    ...
    for term in search_terms:
        term_patients_matched, term_matches = \
                patients.match_patients(term, event_keys=['diagnosis_name'], event_types=['DiagnosisEvent'])
    ...
    diagnosis_event_counters, diagnosis_event_roles, diagnosis_event_entity_levels, diagnosis_event_count_per_entity_level = \
...
def main():
    ...
    patients_db_path = f"{data_dir}/patients_20200826-230117.jsonl"
